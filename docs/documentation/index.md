...
- [Nightshift](nightshift/index.md): run an agent on a long task overnight
  inside an OpenShell sandbox, with reviewed permission expansion and a
  host-written score ledger.
