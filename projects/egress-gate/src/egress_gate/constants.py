...
# Structured request-body parsing limits.
MAX_JSON_DEPTH = 128
MAX_JSON_NODES = 100_000
MAX_JSON_SELECTOR_SEGMENTS = 32
MAX_JSON_SELECTORS = 32
MAX_JSON_SELECTED_NODES = 4_096
MAX_JSON_SELECTED_TEXT_BYTES = MAX_BODY_BYTES
MAX_MESSAGE_BLOCKS = 4_096
...
MAX_AGENT_ATTESTATION_BYTES = 8 * 1024
