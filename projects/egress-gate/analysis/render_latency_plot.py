...
def _render_svg(measurements: list[Measurement], fit: LinearFit) -> str:
    ...
    parts = [
        ...
        '<title id="title">Egress Gate latency versus prompt size</title>',
        (
            '<desc id="description">Scatter plot of 96 Egress Gate service '
        ...
        *[
        ...
        (
            ...
            "Egress Gate latency (ms) · log scale</text>"
        ),
    ]
    ...
    for row in measurements:
        ...
        parts.append(
            ...
            f'cy="{_y(row.egress_gate_latency_ms):.2f}" '
    ...
    parts.extend(
        [
            (
                ...
                f"Egress Gate averaged {100.0 * mean_turn_share:.2f}%</text>"
            ),
            (
