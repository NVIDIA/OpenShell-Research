...
description: Egress Gate components, boundaries, state, and request-processing structure.
agent_markdown: true
---

# System architecture

Egress Gate is a pre-credentials OpenShell middleware. It translates an
...
before a request reaches Egress Gate.

## System boundary

![Egress Gate component architecture. The service layer translates
...
`projects/egress-gate/src/egress_gate/`.
...
processor boundary. Egress Gate does not parse JSON or create structured
regions.
...
![Egress Gate processing pipeline from validated policy and input text
