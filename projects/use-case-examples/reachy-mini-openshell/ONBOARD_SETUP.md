...
the demo, read the [Dev Note](https://github.com/NVIDIA/OpenShell-Research/blob/main/docs/dev-notes/posts/2026-07-20-policy-controlling-reachy-mini-with-openshell.md).
...
git switch main
cd projects/use-case-examples/reachy-mini-openshell
```
...
`projects/use-case-examples/reachy-mini-openshell/native-controller`. It owns only the robot
