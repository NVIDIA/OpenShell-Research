...
import (
	cloudeventsexporter "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter/exporter/cloudeventsexporter"
	storagehealthextension "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter/extension/storagehealthextension"
	evidencecontractprocessor "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter/processor/evidencecontractprocessor"
	openshellprocessor "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter/processor/openshellprocessor"
	relayprocessor "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter/processor/relayprocessor"
	watchsandboxreceiver "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter/receiver/watchsandboxreceiver"
...
func components() (otelcol.Factories, error) {
	...
	factories.ExtensionModules = makeModulesMap(factories.Extensions, map[component.Type]string{
		...
		storagehealthextension.NewFactory().Type():   "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter v0.0.5-rc.1",
	})
	...
	factories.ReceiverModules = makeModulesMap(factories.Receivers, map[component.Type]string{
		...
		watchsandboxreceiver.NewFactory().Type(): "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter v0.0.5-rc.1",
	})
	...
	factories.ExporterModules = makeModulesMap(factories.Exporters, map[component.Type]string{
		...
		cloudeventsexporter.NewFactory().Type():   "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter v0.0.5-rc.1",
	})
	...
	factories.ProcessorModules = makeModulesMap(factories.Processors, map[component.Type]string{
		...
		evidencecontractprocessor.NewFactory().Type(): "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter v0.0.5-rc.1",
		openshellprocessor.NewFactory().Type():        "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter v0.0.5-rc.1",
		relayprocessor.NewFactory().Type():            "github.com/NVIDIA/OpenShell-Research/projects/tools/openshell-exporter v0.0.5-rc.1",
	})
