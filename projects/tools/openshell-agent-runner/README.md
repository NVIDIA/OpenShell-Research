...
From `projects/tools/openshell-agent-runner`, run:
...
[RELEASING.md](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/openshell-agent-runner/RELEASING.md)
