...
CODE_REVIEWER = (
    REPOSITORY
    / "projects/tools/openshell-agent-runner/src/openshell_agent_runner/profiles/code-reviewer"
)
TECHNICAL_WRITING_REVIEWER = (
    REPOSITORY
    / "projects/tools/openshell-agent-runner/src/openshell_agent_runner/profiles/technical-writing-reviewer"
)
