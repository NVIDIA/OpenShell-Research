...
PUBLISH_SCRIPT = REPOSITORY / "projects/tools/openshell-agent-runner/scripts/publish.sh"
PROJECT_MAKEFILE = REPOSITORY / "projects/tools/openshell-agent-runner/Makefile"
