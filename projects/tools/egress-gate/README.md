...
`projects/tools/egress-gate/` in a source checkout, `uv` 0.11+ prepares the project
...
- [Overview](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/index.md)
- [Configuration](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/configuration.md)
- [Request-content parsing](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/request-content.md)
- [Test policies offline](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/evaluation.md)
- [Operations](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/operations.md)
- [Gate authoring](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/gates/custom.md)
- [Regex gate](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/gates/regex.md)
- [Architecture](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/architecture/index.md)
- [Limits and failures](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/egress-gate/docs/reference/limits-and-failures.md)
- [Regex redaction composition](https://github.com/NVIDIA/OpenShell-Research/tree/main/projects/tools/egress-gate/examples/regex-redaction)
- [Function-based custom gate](https://github.com/NVIDIA/OpenShell-Research/tree/main/projects/tools/egress-gate/examples/custom-gate)
- [Class-based custom gate](https://github.com/NVIDIA/OpenShell-Research/tree/main/projects/tools/egress-gate/examples/class-based-gate)
