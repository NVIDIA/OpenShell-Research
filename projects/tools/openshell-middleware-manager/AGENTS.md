...
- `omm create` must never write into, follow, or replace an existing output
...
- Templates in `src/openshell_middleware_manager/templates/` must produce working standalone
  projects.
