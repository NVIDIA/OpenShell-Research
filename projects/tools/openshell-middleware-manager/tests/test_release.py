...
PUBLISH_SCRIPT = REPOSITORY / "projects/tools/openshell-middleware-manager/scripts/publish.sh"
PROJECT_MAKEFILE = REPOSITORY / "projects/tools/openshell-middleware-manager/Makefile"
