...
```sh
uv tool install \
  "openshell-middleware-manager @ git+https://github.com/NVIDIA/OpenShell-Research.git#subdirectory=projects/tools/openshell-middleware-manager"
```
...
```sh
uv tool install /path/to/OpenShell-Research/projects/tools/openshell-middleware-manager
```
...
See [RELEASING.md](https://github.com/NVIDIA/OpenShell-Research/blob/main/projects/tools/openshell-middleware-manager/RELEASING.md)
