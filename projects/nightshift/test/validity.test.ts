...
const clean: OutcomeSignals = {
  done: false, agentTurnCount: 5, toolCallCount: 12, agentExitCode: 0, deadlineReached: true,
  reviewerDecisionCount: 3, reviewerFailureCount: 0, reviewerApplyFailureCount: 0,
  appliedApprovalCount: 0, failClosedApprovalCount: 0, scoreCoverageSufficient: true,
...
test('a reached objective is always a valid run', () => {
  const v = classifyOutcome({ ...clean, done: true, agentTurnCount: 0, policyReloadFailed: true })
