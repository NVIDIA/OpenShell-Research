 ...
 * it as base64 JSON in `NIGHTSHIFT_DRIVER_CONFIG_B64`; the driver never reads `.env`.
...
export interface DriverConfig {
  ...
  model: ModelConfig
  /** Working directory for the agent and its tools; a fresh temporary directory when unset. */
  cwd?: string
