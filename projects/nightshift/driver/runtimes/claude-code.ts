 ...
 * newline-delimited JSON, and maps those records onto the common event
...
export const claudeCodeRuntime: Runtime = {
  ...
  async setup(context): Promise<void> {
    context.emit({ type: 'driver.runtime', runtime: 'claude-code', model: context.config.model.model })
  },
