...
PATTERN_NAME_METADATA_KEY = "pattern_name"

# Request-body and JSON shape limits.
MAX_BODY_BYTES = 4 * 1024 * 1024
MAX_JSON_NESTING = 64
MAX_TEXT_BLOCKS = 4096
MAX_SCANNED_CHARACTERS = 4 * 1024 * 1024

# Scanner and result limits.
MAX_FINDINGS_PER_BLOCK = 256
MAX_FINDINGS_PER_REQUEST = 4096
MAX_SCANNER_METADATA_BYTES = 1024
MAX_FINDING_METADATA_ENTRIES = 32
MAX_PROTO_FINDING_GROUPS = 32
MAX_PROTO_FINDING_BYTES = 4 * 1024

# Regex scanner configuration and execution limits. Catalog limits are independent
# of request result limits: sparse requests can use large, focused rule sets.
MAX_SCANNER_CONFIG_BYTES = 16 * 1024 * 1024
MAX_SCANNER_CONFIG_NESTING = 16
MAX_SCANNER_CONFIG_NODES = 250_000
MAX_SCANNER_CONFIG_SCALAR_BYTES = 16 * 1024
MAX_REGEX_NAME_BYTES = 128
MAX_REGEX_PROFILES = 32
MAX_REGEX_ENTITIES_PER_PROFILE = 2_000
MAX_REGEX_PATTERNS_PER_PROFILE = 10_000
MAX_REGEX_ENTITIES_TOTAL = 10_000
MAX_REGEX_PATTERNS_TOTAL = 50_000
MAX_REGEX_PATTERN_BYTES = 16 * 1024
MAX_MATCHES_PER_PATTERN = 256
DEFAULT_SCAN_TIMEOUT_SECONDS = 1.0
MAX_SCAN_TIMEOUT_SECONDS = 30.0
